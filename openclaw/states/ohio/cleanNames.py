...
def main():
    input_file = 'C:/Users/lucas/Data_Science_Capstone/Capstone/states/ohio/ohio_memorial_highways.csv'
    output_file = 'cleaned_names_ohio.txt'
