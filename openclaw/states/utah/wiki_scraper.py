...
# MAIN
# -----------------------------
with open("utah_cleaned_names.txt", encoding="utf-8") as f:
...
df.to_csv("wiki_scraper_output_utah.csv", index=False)

print(f"\nScraped {len(df)} individuals from Wikidata for Utah.\n")