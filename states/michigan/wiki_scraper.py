...
with open("michigan_cleaned_highway_names.txt", encoding="utf-8") as f:
...
df.to_csv("wiki_scraper_output_michigan.csv", index=False)

print(f"Scraped {len(df)} individuals from Wikidata for Indiana.")