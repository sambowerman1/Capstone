...
with open("non_person_named_highways.txt", encoding="utf-8") as f:
...
df.to_csv("wiki_scraper_non_person.csv", index=False)

print(f"Scraped {len(df)} individuals from Wikidata.")