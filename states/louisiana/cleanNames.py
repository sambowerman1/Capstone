...
def main():
    input_file = 'C:/Users/lucas/Data_Science_Capstone/Capstone/states/louisiana/louisiana_memorial_highways.csv'
    output_file = 'cleaned_names_louisiana.txt'
    ...
    with open(input_file, 'r', encoding='utf-8') as f:
        ...
        for row in reader:
            highway_name = row['Highway_Designation']
